...
class RegisterPlayerFragment : Fragment(R.layout.fragment_player_register), RegisterPlayer.View {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // presenter = RegisterPlayerPresenter(this, DependencyInjector.registerPlayerRepository())
        ...
        btnSave?.setOnClickListener {
            ...
            //presenter.insertPlayer(namePlayer,positionPlayer, levelPlayer, groupPlayer)
